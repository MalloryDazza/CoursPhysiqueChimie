...
## La composition d'un atome Voila une modification

1. Le texte du paragraphe _italique_ __bold__  ___italique et bold___ *italique* **bold** ***italique bold***

2. Ceci n'est pas un paragraphe
...
## slide titreslide titreslide 

### Sous titre 1slide

--
- liste une $C_m$ $^{12}_{23}X$
...
---
background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/160316-031_Bridge_near_Tatopani.jpg/1200px-160316-031_Bridge_near_Tatopani.jpg)
...
---
# Two sides avec un grand titre qui va partout

.pull-left[
## Voici du texte pour le titre

Voici des maths : $C_m = \dfrac{M}{V}$
]
...
---
# Two sides but with left column
...
## Ici on parle vraiment

Voila ce qui est important : les maths avec latex Voila ce qui est important : les maths avec latex Voila ce qui est important : les maths avec latex Voila ce qui est important : les maths avec latex Voila ce qui est important : les maths avec latex Voila ce qui est important : les maths avec latex Voila ce qui
...
## Titre moins long, mais un peu plus

## TITRE EST DIFFERENT

Un pue de exte isi aussi c'est posilee 
